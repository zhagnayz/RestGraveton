...
class CheckBox: UIControl {
    ...
    var useHapticFeedback: Bool = false
    ...
    open override func draw(_ rect: CGRect) {
        ...
        if isChecked {
            ...
            switch self.style {
            case .circle:self.drawCircle(frame: newRect)
            case .cross:self.drawCross(frame: newRect)
            case .tick:self.drawCheckMark(frame: newRect)
            }
        }
    }
